  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    " class="brand-link">
      <img src="{{ asset('dist/img/ixambee-logo-for-dark-bg.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
           <span style="font-weight: light; font-style: italic; font-size: 24px; color: white; ">Hive</span>
      </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
              <a href="{{route('drag-n-drop')}}" class="nav-link">
                  <i class="fas fa-list-alt nav-icon"></i>
                  <p>Drag n Drop</p>
                </a>
              </li>
              ...
              @endif
              <li class="nav-item">
              <a href="{{route('my-notes')}}" class="nav-link">
